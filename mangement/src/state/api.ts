...
// Getting access to our API gateway from aws
export const api = createApi({
  ...
  endpoints: (build) => ({
    // Get the Endpoints from Cognito
    ...
    // will make the call for project here from the backend --
    ...
    createProject: build.mutation<Project, Partial<Project>>({
      ...
      invalidatesTags: ["Projects"], // to get updated vision for the project
    }),
    // will make the call for project here from the backend --

...
const COLORS = ["#475569", "#00C49F", "#FFBB28", "#FF8042"];
            ...
            <h1 className="text-2xl font-semibold dark:text-white py-4">Project Management Dashboard</h1>
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div className="dashboard-cards rounded-lg bg-white p-4 shadow dark:bg-dark-secondary">
                  <h3 className="mb-4 text-xs font-semibold dark:text-white">
                ...
                <div className="rounded-lg bg-white p-4 shadow dark:bg-dark-secondary md:col-span-2 mb-4">
                  <h3 className="mb-4 text-xs font-semibold dark:text-white">
                    Your Tasks
                  </h3>
